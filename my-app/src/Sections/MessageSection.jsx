...
const MessageSection = () => {
    useGSAP(() => {
        ...
        revealT1.to('.msg-text-scroll',{
            duration:1,
            ease:'circ.inOut',
            clipPath: 'polygon ( 0 0 , 100% 0, 100% 100%, 0 100%)'
        });
        const parahraphT1 = gsap.timeline({
            scrollTrigger:{
                trigger:'.message-content p',
                start:'top center',
            },
        });
        parahraphT1.from(paragraphSplit.words,{
            yPercent:300,
            rotate:3,
            ease:'power1.inOut',
            stagger:0.01,
...
return (
    <section className="message-content" id="message">
        <div className="mx-auto flex-center py-28 relative">
                ...
                <div className="msg-wrapper">
                    ...
                    <div
                        ...
                        <div className="bg-light-brown md:pb-5 pb-3 px-5 ">
                            <h2 className="text-red-browm">FUEL UP</h2>
                        </div>
                    </div>
